    ...
    return (
        <HomeStyles>
            ...
            <p>Вопросы собираются из разных источников: личного опыта, занятных постов из социальных сетей, часть
                вопросов взята из <a href="https://github.com/lydiahallie/javascript-questions" target="_blank">репозитория
                    Lydia Hallie</a>.</p>
            ...
            <p>Консоль — open source проект. Вы можете предлагать свои вопросы для тестовых заданий в открытом
                репозитории на <a href="https://github.com/oxitenko/js-tests">GitHub</a>.</p>
        </HomeStyles>
    );
};
